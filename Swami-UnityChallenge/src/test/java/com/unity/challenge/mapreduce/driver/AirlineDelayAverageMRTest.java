...
public class AirlineDelayAverageMRTest {
  ...
  public void setup() {
    ...
    AverageCSVReduce reducer1 = new AverageCSVReduce();
    AverageCSVMapper mapper1 = new AverageCSVMapper();
    mapReduceDriver = MapReduceDriver.newMapReduceDriver(mapper1, reducer1);
    mapReduceDriver.setCombiner(new AverageCSVCombiner());
    AverageCSVReduce reducer2 = new AverageCSVReduce();
    AverageCSVMapper mapper2 = new AverageCSVMapper();
  ...
  public void mapperTest() throws IOException, InterruptedException {
    ...
    Text t4 =
        new Text(
            "2006,1,11,3,743,745,1024,1018,US,343,N657AW,281,273,223,3,-2,ATL,PHX,1587,45,13,0,,0,0,0,0,0,0");
    mapDriver.withInput(new LongWritable(1l), t1).withInput(new LongWritable(2l), t2)
        ...
        .withOutput(new PairWritable(new Pair<String, String>("ATL", "PHX")), new MetricPair(3))
        .runTest();
    Assert.assertEquals(
  ...
  public void testMapReduce() throws IOException {
    ...
    mapReduceDriver
        .withInput(new LongWritable(), inputT1)
        .withInput(new LongWritable(), inputT2)
        .withInput(new LongWritable(), inputT3)
        .withOutput(outputT2, NullWritable.get())
        .withOutput(outputT1, NullWritable.get()).runTest();
  ...
  public void reducerTest() throws IOException, InterruptedException {
    ...
    reducerDriver.withInput(wr1, values)
     ...
     .withOutput(new Text("ATL-PHX,4.5"), NullWritable.get()).runTest();
    Assert.assertEquals(
